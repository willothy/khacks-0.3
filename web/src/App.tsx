...
function App() {
  ...
  return (
    ...
    onClick={() => handleClick(3)}>Hi</button>
    <button className="absolute top-12 right-12 h-20 w-20 rounded-lg  bg-pink-400 transition-all hover:scale-110 hover:bg-pink-700"
    onClick={() => handleClick(4)}>Hi</button>


    <button className="absolute bottom-16 right-40 h-20 w-20 rounded-lg  bg-purple-300 transition-all hover:scale-110 hover:bg-blue-300"
    onClick={() => handleClick(2)}>Hi</button>
    <button className="absolute bottom-16 right-64 h-20 w-20 rounded-lg  bg-purple-300 transition-all hover:scale-110 hover:bg-blue-300"
    onClick={() => handleClick(3)}>Hi</button>
    <button className="absolute bottom-16 right-96 h-20 w-20 rounded-lg  bg-purple-300 transition-all hover:scale-110 hover:bg-blue-300"
    onClick={() => handleClick(4)}>Hi</button>
